<?php $title="View Profile" ; ob_start(); include($_SERVER[ 'DOCUMENT_ROOT']. '/required/header.php'); include($_SERVER[ 'DOCUMENT_ROOT']. '/required/navigation.php');?>
...
<div class='pagebody clearfix'>
   <div class='content-container'>
      ...
      <div class='pagecontent clearfix'>
      	<form class='regform clearfix' id='insert_register' action='<?php htmlspecialchars($_SERVER["PHP_SELF"]) ?>' method='post'>
      	<?php
