...
$sql = "SELECT * FROM patients WHERE (first_name LIKE '%" .$first_name. "%' AND last_name LIKE '%" .$last_name. "%') ORDER BY last_name ASC;" ;
		...
		<div class="pagecontent clearfix">
			<div class='show_patients'>
				...
				if (mysqli_num_rows($result)> 0) { echo "
					...
					echo "<div class='alert alert-danger' role='alert'><p>0 results</p></div>" ;
				} 
				?>
				</table>
